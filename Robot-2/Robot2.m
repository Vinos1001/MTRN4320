    ...
    if length(stringcells) > 1
        ...
        if j==1
            if(length(stringcells{1})==length(stringcells{2}))
                x_offset = 30;
            elseif length(stringcells{1})>length(stringcells{2})
                x_offset = (length(stringcells{1})-length(stringcells{2})+1) *30;
            elseif length(stringcells{1})<length(stringcells{2})
                x_offset = (length(stringcells{1})-length(stringcells{2})+1)*30;
            else
                x_offset = 0;
        ...
        if(j==2)
            if(length(stringcells{1}) > length(stringcells{3}))
                x_offset = (length(stringcells{1})- length(stringcells{3}))*30;
